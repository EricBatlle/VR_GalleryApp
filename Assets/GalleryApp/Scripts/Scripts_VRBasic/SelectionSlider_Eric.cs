...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider_Eric : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject m_Portraits;
        ...
        private void OnBarF()
        {
            //if (m_SceneToLoad.Equals("Menu"))
            //{
            //    //MenuAction
            //    m_Portraits.GetComponent<Close_Menu>().StartMenuAction();
            //}
            //if
            //{
                //Go Menu
